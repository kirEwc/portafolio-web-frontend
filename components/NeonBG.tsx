...
export default function NeonBG () {
  ...
  <span className="absolute top-10 left-1/3 w-20 h-20 bg-blue-500 dark:bg-blue-400 rounded-3xl skew-y-6 blur-md opacity-60"></span>
  ...
  {/* Rosa - Centro Derecha */}
  <span className="absolute top-1/3 right-8 left-3/4 -translate-x-80 -translate-y-32 w-24 h-24 bg-pink-600 dark:bg-pink-400 rounded-3xl skew-y-3 blur-xl opacity-60"></span>
